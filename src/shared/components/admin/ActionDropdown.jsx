      ...
      {open && typeof document !== 'undefined'
        ? createPortal(
          <div
            ...
            className="origin-top-right rounded-lg border border-outline-variant bg-surface-container-lowest p-1 shadow-[0_8px_20px_rgba(15,23,42,0.14)] animate-[nurseFadeSlideIn_180ms_ease-out]"
          >
            {items.map((item) => (
              <button
                key={item.id}
                ...
                className="nurse-focus-ring flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-left text-xs font-medium text-on-surface-variant transition-[background-color,color] duration-150 ease-out hover:bg-surface-container-low focus-visible:bg-surface-container-low"
              >
