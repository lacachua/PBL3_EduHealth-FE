    ...
    <section className="app-panel-shell px-4 py-3 sm:px-5">
      ...
      >
        ...
        <select
          ...
          className="app-focus-ring app-input h-9 w-full rounded-lg px-3 text-sm xl:w-[184px] xl:shrink-0"
        ...
        <button
          ...
          className={`app-focus-ring inline-flex h-9 w-full shrink-0 items-center justify-center gap-1.5 rounded-lg border px-3 text-sm font-semibold transition xl:w-[156px] ${value.incompleteOnly
