  ...
  <div className="flex flex-wrap items-center gap-2">
    {groups.map((group) => (
      <button
        ...
        className={`rounded-full border px-3.5 py-1.5 text-xs font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/20 ${activeGroup === group.value
